...
from d_bjh_pinn.train import save_checkpoint, train
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    train_parser.add_argument("--checkpoint", type=str, default="checkpoint.pt")
...
def _run_train(args: argparse.Namespace) -> None:
    ...
    state = train(data_config, model_config, train_config)
